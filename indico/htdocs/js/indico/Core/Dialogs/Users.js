...
type("AuthorDataPopup", ["ExclusivePopupWithButtons"],
    {
        draw: function() {
	       ...
	       [$T('Affiliation address'), $B(self.parameterManager.add(Html.edit({style: {width: '300px'}}), 'text', false), userData.accessor('address'))],
               [$T('Email'),  $B(self.parameterManager.add(Html.edit({style: {width: '200px'}}), 'email', false), userData.accessor('email'))],
[$T('Telephone'), $B(self.parameterManager.add(Html.edit({style: {width: '150px'}}), 'text', false), userData.accessor('phone'))]
               ]);
